...
public class LoginDetailDAOImpl extends HibernateDaoSupport implements LoginDetailDAO {
    ...
    public UserLog retriveFromulogin(String username, String userpassword) {
        ...
        users = getHibernateTemplate().find("from UserLog user where user.username='" + username + "' and user.userpassword='" + userpassword + "'");
    ...
    public UserLog retriveChangePassword(String userId) {
        ...
        users = getHibernateTemplate().find("from UserLog u where u.id1='" + userId+"'");
        return users.get(0);
    ...
    public List<UserLog> fetchalluserdetails() {
        ...
        users = getHibernateTemplate().find("from UserLog u where u.verify='yes'");
        return users; 
    }
